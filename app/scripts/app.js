...
var stellarClient = angular.module('stellarClient', ['bruteRequest', 'ui.router', 'rt.debounce', 'vr.passwordStrength', 'ngTable', 'ngRoute', 'keygen', 'dataBlob', 'angularMoment','filters']);
